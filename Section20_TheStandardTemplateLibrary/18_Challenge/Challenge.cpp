 ...
 * The next file is named 'words.txt' and contains the first few paragraphs from the book. "The Wonderful Wizard of Oz" by L. Frank Baum. 
 * 
 * Part 1:
 * For part 1 of this challenge, you are to display each unique word in the file and immediately following each word display the number of time it occurs in the text file. 
 * 
 ...
 * 
 * The words should be displayed in ascending order and the line numbers for each word should also be displayed in ascending order. 
 ...
 * I have also provided the functions that display the maps as well as the function that cleans  the words read. 
 * You should call the clean_string function for every word you read from the file. 
 * 
 * ****/
...
// Used for Part1
// Display the word and count from the std::mao <std::string, int>
...
// Part1 process the file and builds a map of words and the number of times they occur in the life
void part1(){
